...
let SettingsController = class SettingsController {
    ...
    async debugEmailKeys() {
        ...
        const emailSettings = await this.settingsService.getSetting(`emailSettings_base_${baseId}`);
...
__decorate([
    (0, common_1.Get)('public/debug-email-keys'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], SettingsController.prototype, "debugEmailKeys", null);
__decorate([
