...
let AnalyticsController = class AnalyticsController {
    ...
    async getGlobalStats(query, req) {
        const filters = {
            ...
            countryId: req.headers['x-selected-country'],
        };
    ...
    async getTCO(query, req) {
        const filters = {
            ...
            country: req.headers['x-selected-country'],
        };
        return this.analyticsService.calculateTCO(filters);
    }
    async getCostForecast(months, req) {
        return this.analyticsService.predictCosts(req.headers['x-selected-country'], months);
    }
};
