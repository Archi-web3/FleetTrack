...
let AuditLogsController = class AuditLogsController {
    ...
    async getLogs(limitStr, category, pays) {
...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.RequirePermissions)('SuperAdmin', 'Super Admin'),
    __param(0, (0, common_1.Query)('limit')),
    __param(1, (0, common_1.Query)('category')),
    __param(2, (0, common_1.Query)('pays')),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AuditLogsController.prototype, "clearLogs", null);
