...
exports.BasesModule = BasesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: base_schema_1.Base.name, schema: base_schema_1.BaseSchema }]),
        ],
        controllers: [bases_controller_1.BasesController],
        providers: [bases_service_1.BasesService],
        exports: [bases_service_1.BasesService, mongoose_1.MongooseModule],
    })
], BasesModule);
