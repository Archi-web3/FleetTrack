...
import { Maintenance } from '../../core/services/offline.service';
    ...
    <mat-dialog-content>
      <mat-list>
        ...
        <mat-list-item>
          ...
          <div matListItemLine>
            {{ data.maintenance.cost | currency: 'EUR' : 'symbol' : '1.2-2' }}
          </div>
        </mat-list-item>
        ...
        <mat-list-item>
          ...
          <div matListItemLine>
            <span [style.color]="data.maintenance.synced ? 'green' : 'orange'">
              {{
                (data.maintenance.synced ? 'TRIP_DETAILS.SYNCED' : 'TRIP_DETAILS.WAITING')
                  | translate
              }}
            </span>
          </div>
...
export class MaintenanceDetailsDialogComponent {
  dialogRef = inject<MatDialogRef<MaintenanceDetailsDialogComponent>>(MatDialogRef);
  data = inject<{
