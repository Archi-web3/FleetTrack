...
@Component({
  ...
  standalone: true,
  imports: [MatCardModule, MatGridListModule, MatIconModule, BaseChartDirective, TranslateModule],
  template: `
...
export class StatisticsComponent implements OnInit {
  ...
  public barChartData: ChartData<'bar'> = {
    labels: [],
    datasets: [{ data: [], label: 'Distance (km)', backgroundColor: '#005FB6' }],
  };
  ...
  loadStatusStats() {
    this.http
      .get<any[]>('https://fleettrack-api.onrender.com/api/mouvements/stats-by-status')
      .subscribe((data) => {
  ...
  loadVehicleStats() {
    this.http
      .get<any[]>('https://fleettrack-api.onrender.com/api/mouvements/stats-by-vehicle')
      .subscribe((data) => {
        ...
        this.barChartData = {
          labels: labels,
          datasets: [{ data: distances, label: label, backgroundColor: '#005FB6' }],
        };
      });
  }
}
