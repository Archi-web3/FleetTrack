...
export class ServiceValidationDialogComponent implements OnInit {
  dialogRef = inject<MatDialogRef<ServiceValidationDialogComponent>>(MatDialogRef);
    ...
    try {
      ...
      if (currentTachesStr !== this.tachesInitialesStr) {
        await this.trackingService
          .updateServiceTasks(this.service._id, this.service.taches)
          .toPromise();
      }
