...
export class InterventionFormComponent implements OnInit {
  ...
  tasks250 = [
    ...
    {
      id: 'verifierEtat',
      label: "Vérifier l'état général, propreté, nettoyage de tâche de liquide",
    },
    { id: 'verifierNivRefr', label: 'Vérifier le niveau de liquide de refroidissement' },
    {
      id: 'verifierFuites',
      label: "Vérifier les fuites d'huiles, essence, liquide de refroidissement",
    },
    {
      id: 'vidangerFiltreFuel',
      label: "Vidanger le filtre d'essence primaire (& secondaire) séparateur d'eau",
    },
    { id: 'verifierCourroie', label: "Vérifier la courroie d'alternateur & ventilateur" },
    {
      id: 'verifierNivBatt',
      label: "Vérifier le niveau d'électrolyte batterie (et faire l'appoint si nécessaire)",
    },
    {
      id: 'vidangerHuile',
      label: "Vidanger l'huile moteur & remplissage avec de l'huile neuve adaptée",
    },
    { id: 'vidangerCondensats', label: "Vidanger les condensats du silencieux d'échappement" },
    {
      id: 'nettoyerRefroidissement',
      label: 'Nettoyer le système de refroidissement (Faisceau radiateur)',
    },
  ...
  tasks500 = [
    {
      id: 'changerFiltres',
      label: 'Changer les filtres (huile, essence, liquide de refroidissement, air)',
    },
    {
      id: 'verifierTuyaux',
      label: "Vérifier l'intégralité des tuyaux et durites (huile/essence/liquide/air)",
    },
  ];
  ...
  tasks1000 = [
    ...
    {
      id: 'vidangeLiquideRefr',
      label: 'Vidange Liquide de refroidissement (Rinçage & Nettoyage du circuit)',
    },
  ];
  ...
  tasks3000 = [
    {
      id: 'testerInjecteurs',
      label: "Tester et/ou changer les injecteurs d'essence / Changer toutes les courroies",
    },
  ...
  onFrequenceChange() {
    ...
    if (this.intervention.frequence) {
      this.intervention.prochaineMaintenanceHeures =
        this.intervention.heuresActuelles + this.intervention.frequence;
    }
  }
